...
class EGNN(nn.Module):
    def __init__(self, in_node_nf, hidden_nf, out_node_nf, in_edge_nf=0, device='cuda:0', act_fn=nn.LeakyReLU(), n_layers=4, residual=True, attention=False, normalize=False, tanh=False):
        '''
